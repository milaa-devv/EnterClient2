        ...
        if (ob) {
          ...
          if (Array.isArray(cfg.productos) && cfg.productos.length > 0) {
            ...
            if (producto === 'ENTERFAC') {
              setEmpresa((e) => ({ ...e, plataforma: 'Enterfact' }));
          ...
          } else if (cfg.representantes && Array.isArray(cfg.representantes) && cfg.representantes.length > 0) {
            // Si no hay contactos pero hay representantes, crear contacto principal desde el primer representante
          ...
          if (cfg.representantes && Array.isArray(cfg.representantes) && cfg.representantes.length > 0) {
            setRepresentantes(cfg.representantes.map((r: any) => ({
              rut: r.rut || "—",
              nombre: r.nombre || "—"
            })));
          }
